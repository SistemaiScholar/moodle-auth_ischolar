...
/**
 * Classe para autenticação usando o plugin iScholar Access.
 *
 * @package auth_ischolar
 * @author Walter Alexandre
...
//$user = false; // só um teste
        ...
        //else {
        //    $config = config::getsettings();
        //    redirect('https://'.$config->schoolcode.'.paineldoaluno.com.br/painel');
        //}
    }
